...
var file_hello_proto_rawDesc = []byte{
	...
	0x09, 0x52, 0x04, 0x64, 0x61, 0x74, 0x61, 0x32, 0x64, 0x0a, 0x05, 0x48, 0x65, 0x6c, 0x6c, 0x6f,
	...
	0x6c, 0x6c, 0x6f, 0x52, 0x65, 0x73, 0x70, 0x6f, 0x6e, 0x73, 0x65, 0x22, 0x00, 0x12, 0x2e, 0x0a,
	0x07, 0x43, 0x68, 0x61, 0x6e, 0x6e, 0x65, 0x6c, 0x12, 0x0e, 0x2e, 0x53, 0x74, 0x72, 0x65, 0x61,
	0x6d, 0x52, 0x65, 0x71, 0x75, 0x65, 0x73, 0x74, 0x1a, 0x0f, 0x2e, 0x53, 0x74, 0x72, 0x65, 0x61,
	0x6d, 0x52, 0x65, 0x73, 0x70, 0x6f, 0x6e, 0x73, 0x65, 0x28, 0x01, 0x30, 0x01, 0x42, 0x0a, 0x5a,
...
var file_hello_proto_depIdxs = []int32{
	...
	2, // 1: Hello.Channel:input_type -> StreamRequest
	1, // 2: Hello.SayHello:output_type -> HelloResponse
	3, // 3: Hello.Channel:output_type -> StreamResponse
...
// HelloClient is the client1 API for Hello service.
//
...
func (c *helloClient) Channel(ctx context.Context, opts ...grpc.CallOption) (Hello_ChannelClient, error) {
	stream, err := c.cc.NewStream(ctx, &_Hello_serviceDesc.Streams[0], "/Hello/Channel", opts...)
	if err != nil {
		return nil, err
	}
